                    ...
                    <KeyboardAwareScrollView>
                        ...
                        <View style = {{marginLeft:'5%',width:'90%',marginTop:'2%'}}>
                            ...
                            <TextInput style={styles.inputss}
                                       placeholderTextColor='rgba(0, 0, 0, 0.6)'
                                       onChangeText={(text) => this.setState({weight:text})} placeholder={" Weight(In Kg)"}/>
                            ...
                            <View style = {{flexDirection:'row'}}>
                                ...
                                <TouchableOpacity onPress={() => this.props.navigation.navigate('BasicSurgies')
                                }>
                                    <Text style = {{color:'black',marginTop:30,marginLeft:-70,fontSize:17}}>
                                        SELECT
                                    </Text>
                                </TouchableOpacity>
                            ...
                            <View style = {{flexDirection:'row'}}>
                                ...
                                <TouchableOpacity onPress={() => this.props.navigation.navigate('Illness')
                                }>
                                    <Text style = {{color:'black',marginTop:30,marginLeft:-70,fontSize:17}}>
                                        SELECT
                                    </Text>
                            ...
                            <View style = {{flexDirection:'row'}}>
                                ...
                                <TouchableOpacity onPress={() => this.props.navigation.navigate('Allergies')
                                }>
                                <Text style = {{color:'black',marginTop:30,marginLeft:-70,fontSize:17}}>
                                    SELECT
                                </Text>
